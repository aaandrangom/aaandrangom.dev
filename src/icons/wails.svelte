<script lang="ts">
  ...
  let { width = 30, height = 30, styles = '' }: IconProps = $props();
</script>

<svg xmlns="http://www.w3.org/2000/svg" {width} {height} class={styles} viewBox="0 0 24 24"
  ><title>Wails SVG Icon</title><path
    fill="currentColor"
